...
écrite **ici**. Ce fichier est le seul endroit d'où elle peut tirer un vécu.

## Règle absolue pour la routine
...
3. Illustre alors avec des **situations types présentées comme telles** :
   « le cas le plus fréquent : un site vitrine sur mutualisé avec quarante
...
5. En cas de doute sur une affirmation : passe à la formulation impersonnelle et
   vérifiable, ou supprime-la.

## Comment Paul ajoute un cas (30 secondes, pas besoin de rédiger)

Copier ce bloc sous « Cas réels » et remplir en style télégraphique :

```
### <titre court du cas>
- contexte : <type de site, hébergeur, volume, budget>
- problème : <ce qui n'allait pas>
- fait : <ce que j'ai fait concrètement>
- résultat : <chiffré si mesuré, sinon « non mesuré »>
- sujets : <mots-clés ou slugs d'articles où le cas est pertinent>
```
...
<!--
Vide pour l'instant. Tant que cette section est vide, les articles restent
factuels et impersonnels sur les preuves : aucune expérience chiffrée ne doit
apparaître (cf. règle 4).
-->
